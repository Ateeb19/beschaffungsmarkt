                    ...
                    <div className="dashboard-menue-list f-flex flex-column align-items-start justify-content-start w-100 mt-4">
                        <ul className="d-flex flex-column align-items-start justify-content-start w-100 p-0">
                            ...
                            {show_company && (
                                <div className="">
                                    <ul className="das-sub-menu-ul">
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/company/general-settings")}>General Settings</li>
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/company/contact-settings")}>Contact Settings</li>
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/company/product-management?page=1")}>Product Management</li>
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/company/certificates?page=1")}>Certificates</li>
                                    </ul>
                                </div>
                            )}
                            ...
                            {show_post && (
                                <div className="">
                                    <ul className="das-sub-menu-ul">
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/post/my-posts?page=1")}>My Posts</li>
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/post/new-post")}>Add New Post</li>
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/post/like-posts?page=1")}>Favourites</li>
                                    </ul>
                                </div>
                            )}

                            <li className={`w-100 text-start d-flex flex-row justify-content-between ${list === 'setting' ? 'das-li-bg' : ''}`} onClick={() => { setShow_Setting(!show_Setting); setList('setting') }} ><div><RiUserSettingsLine className="fs-5 me-2" /> Settings</div> <div> {show_Setting ? (< FaAngleUp />) : (<FaAngleDown />)}</div></li>
                            {show_Setting && (
                                <div className="">
                                    <ul className="das-sub-menu-ul">
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/profile")}>Profile</li>
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/my-plan")}>My Plan</li>
                                        <li className="w-100 text-start d-flex flex-row justify-content-between das-sub-menu" onClick={() => navigate("/dashboard/notifications?page=1")}>Notifications</li>
                                    </ul>
                                </div>
                            )}
