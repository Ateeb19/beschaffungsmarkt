    ...
    const fetchSponsors = async () => {
      try {
        const response = await axios.get(
          `${Backend_URL}/api/users/random-sponsor-data`,
          {
            headers: {
    ...
    const fetchCategories = async () => {
      try {
        const res = await axios.get(
          `${Backend_URL}/api/categories/get-all-main-category`,
        );
          ...
          <div className="container">
            <div className="d-flex flex-column justify-content-center align-items-center">
              <div className="d-flex flex-column Hero-heading">
                <div className="heading">German and Turkish Trading</div>
              </div>
              ...
              <div className="d-flex flex-column justify-content-center align-items-center mt-4">
                <div className="d-flex flex-column Hero-title">
                  <div className="title">
                    We connect German and Turkish companies for successful trade
                    and cooperation
                  </div>
                </div>
              </div>
              ...
              <div className="d-flex-flex-column justify-content-center align-items-center mt-4">
                <div className="d-flex flex-column flex-md-row justify-content-center align-items-center hero-serch gap-3 w-100">
                  <div className="serch-input w-100 w-md-100">
                    <input
                      type="text"
                      className=""
                  ...
                  <div className="serch-category serch-category w-100 w-md-100">
                    <select
                  ...
                  <div className="serch-btn w-100 w-md-100">
                    <button
                      className=""
                      onClick={() =>
                        navigate(
                          `/companies?keyword=${searchInput}&maincategory=${category}&subcategory=&page=1`,
                        )
                      }
                    >
                      {" "}
                      <IoSearchSharp className="fs-5" /> Search Now
                    </button>
                  </div>
                </div>
              </div>
                      ...
                      {main_category.map((cat, key) => (
                        <>
                          <div
                            ...
                            onClick={() =>
                              navigate(`/companies?maincategory=${cat._id}`)
                            }
                          >
                            <button>
                              <span>
          ...
          <div className="container w-100">
            <div className="row align-items-center">
              <div className="col-12 col-md-6 pt-3">
                ...
                <div className="d-flex justify-content-start align-items-start w-100 home-2-heading text-start mt-2 mt-md-5">
                  <span>Best performing product categories</span>
                </div>
                <div className="d-flex justify-content-start align-items-start w-100 home-2-title text-start mt-3 mb-2 mt-mb-0 mt-md-5">
                  <span>
                    Beschaffungsmarkt offers a wide range of categories,
                    including fashion & accessories, Shoes, Automotive, etc.
                  </span>
                </div>
              </div>
              <div className="col-12 col-md-6 pt-3">
                <div className="d-flex flex-column home-2-image w-100">
                  <img
                    src="/beschaffungsmarkt_images/category-section-D94vXXGx.png"
                    width="100%"
                    alt=""
                    className=""
                    loading="lazy"
                  ...
                  {random_category.map((ram, key) => (
                    <>
                      <div className="col-6 col-md-4 col-lg-2">
                        <div
                          className="d-flex flex-column align-items-center justify-content-center home-2-category-box"
                          onClick={() =>
                            navigate(`/companies?maincategory=${ram._id}`)
                          }
                        >
                          {(() => {
            ...
            <div className="row align-items-center py-5">
              <div className="col-12 col-md-6 text-center text-md-start mb-4 mb-md-0">
                ...
                <div className="d-flex flex-column justify-content-start align-items-start w-100 home-2-title text-start mt-4">
                  <p className="mb-4">
                    Explore a world of top-tier products and trusted suppliers
                    from Germany and Turkey, all in one place. Our platform
                    connects you with leading companies known for their
                    excellence, offering a diverse range of high-quality
                    products across various industries.
                  </p>
                  <p>
                    Whether you're looking for cutting-edge mechanical
                    engineering solutions, premium textiles, or high-quality
                    food products, our marketplace ensures that you find exactly
                    what you need to drive your business forward. With a focus
                    on reliability and innovation, we make it easier than ever
                    to access the best offerings from these two powerhouse
                    economies.
                  </p>
                </div>
              ...
              <div className="col-12 col-md-6">
                <div className="d-flex flex-column home-2-image w-100 ms-md-5">
                  <img
                    src="/beschaffungsmarkt_images/offer-section-DU4ZBTvX.png"
                    width="100%"
                    height="100%"
                    alt=""
                    className=""
        ...
        <section className="home-4-wrapper w-100">
          <div className="container">
            ...
            >
              ...
              <div className="d-flex justify-content-center align-items-center w-100 home-2-title mt-3">
            ...
            <div className="d-flex flex-column align-items-center justify-content-center w-100">
              ...
              <div className="row justify-content-center text-center mt-4 gap-4 mx-0">
                <div className="d-flex flex-column align-items-center justify-content-center home-steps">
                  <div className="d-flex flex-column step-circle">
                    <img
                      src="/beschaffungsmarkt_images/benefits icon 1.svg"
                      alt=""
                      width="100%"
                      loading="lazy"
                    />
                  ...
                  <div className="d-flex align-items-center justify-content-cetner step-text text-center w-100">
                    <p>
                      Direct contact to leading providers and suppliers from
                      various industries.
                    </p>
                  </div>
                </div>
                <div className="d-flex flex-column align-items-center justify-content-center home-steps">
                  <div className="d-flex flex-column step-circle">
                    <img
                      src="/beschaffungsmarkt_images/benefits icon 2.svg"
                      alt=""
                      width="100%"
                      loading="lazy"
                    />
                  ...
                  <div className="d-flex align-items-center justify-content-cetner step-text text-center w-100">
                    <p>
                      Quick and easy navigation through the best offers in the
                      region.
                    </p>
                  </div>
                </div>
                <div className="d-flex flex-column align-items-center justify-content-center home-steps">
                  <div className="d-flex flex-column step-circle">
                    <img
                      src="/beschaffungsmarkt_images/benefits icon 3.svg"
                      alt=""
                      width="100%"
                      loading="lazy"
                    />
                  ...
                  <div className="d-flex align-items-center justify-content-cetner step-text text-center w-100">
                    <p>
                      High-quality products with high demand in the
                      German-Turkish trade.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="row align-items-center gy-5 mx-0">
              <div className="col-12 col-md-6 text-center text-md-start">
                <div className="d-flex flex-column align-items-start justify-content-start w-100">
                  <div className="d-flex align-items-start text-start home-5-heading mb-4 mb-md-5">
                    <span>Join 4,000+ customers growing with us!</span>
                  </div>
                  <div className="d-flex align-items-start text-start home-5-text mb-4">
                    <p>
                      Experience seamless on all our commodity orders. Maximize
                      your profits, save on costs, and export confidently with
                      our advanced tools and features.
                    </p>
                  </div>
              ...
              <div className="col-12 col-md-6">
                <div className="d-flex flex-column home-5-image w-100 ms-md-5 align-items-center align-items-md-start">
                  <img
                    src="/beschaffungsmarkt_images/counter-section-CDF_S1CJ.png"
                    width="80%"
                    alt=""
                    className=""
                    loading="lazy"
        ...
        <section className="home-6-authors">
          <div className="container w-100">
            <div className="d-flex flex-column align-items-center justify-content-center w-100">
              ...
              <div className="d-flex justify-content-center align-items-center w-100 home-2-heading text-center mt-3">
                <span>Top Companies of The Year</span>
              </div>
              ...
              <div className="d-flex flex-column flex-lg-row align-items-center justify-content-center gap-4 mt-4">
                    ...
                    {sponsors.map((d, key) => (
                      <>
                        <div
                          ...
                          onClick={() => navigate(`/company/${d._id}`)}
                        >
                            ...
                            <div class="card-container">
                              <div class="card text-start">
                                ...
                                <div class="contact-name blur-text">
                                  Contact Person
                                </div>
                                <div class="contact-label blur-text">
                                  Position
                                </div>
