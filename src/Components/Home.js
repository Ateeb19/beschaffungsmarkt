                    ...
                    <div className="container w-100">
                        ...
                        <div className="d-flex flex-row align-items-center justify-content-center gap-5 mt-5">
                            <div className="d-flex flex-column align-items-center justify-content-center home-2-category-box">
                                <GiMetalScales className="text-primary mb-3" style={{ fontSize: '50px' }} />
                                <span>Metals and Heavy Industry</span>
                            </div>
                            <div className="d-flex flex-column align-items-center justify-content-center home-2-category-box">
                                <FaCarSide className="text-primary mb-3" style={{ fontSize: '50px' }} />
                                <span>Automotive</span>
                            </div>
                            <div className="d-flex flex-column align-items-center justify-content-center home-2-category-box">
                                <GiRubberBoot className="text-primary mb-3" style={{ fontSize: '50px' }} />
                                <span>Shoes</span>
                            </div>
                            <div className="d-flex flex-column align-items-center justify-content-center home-2-category-box">
                                <GiElectricalResistance className="text-primary mb-3" style={{ fontSize: '50px' }} />
                                <span>Electrical and Electronics</span>
                            </div>
                            <div className="d-flex flex-column align-items-center justify-content-center home-2-category-box">
                                <GiLeatherArmor className="text-primary mb-3" style={{ fontSize: '50px' }} />
                                <span>Textiles & Leather</span>
                            </div>
                            <div className="d-flex flex-column align-items-center justify-content-center home-2-category-box">
                                <PiBowlFoodFill className="text-primary mb-3" style={{ fontSize: '50px' }} />
                    ...
                    <div className="container w-100">
                        <div className="d-flex flex-row align-items-center justify-content-center w-100 py-5">
                            <div className="col-md-6">
                                ...
                                <div className="d-flex flex-column justify-content-start align-items-start w-100 home-2-title text-start mt-5">
                                    <p className="mb-5">Explore a world of top-tier products and trusted suppliers from Germany and Turkey, all in one place. Our platform connects you with leading companies known for their excellence, offering a diverse range of high-quality products across various industries.</p>
                                ...
                                <div className="d-flex align-items-start jusitfy-content-start w-100">
                                    <div className="serch-btn ">
                                        <button className="px-5 py-2 fs-5">Contact US</button>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-6">
                ...
                <section className="pricing-wrapper w-100">
                    <div className="countainer">
                        <div className="d-flex flex-column align-items-center justify-content-center w-100">
                            ...
                            <div className="d-flex justify-content-center align-items-center w-100 home-6-switch gap-4 mt-3 form-switch">
                                <span>Monthly</span>
                            ...
                            <div className="d-flex flex-row align-items-center justify-content-center gap-5 w-100 mt-4">
